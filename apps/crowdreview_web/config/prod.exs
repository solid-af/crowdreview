...
# CrowdReview.Web.Endpoint.load_from_system_env/1 dynamically.
...
config :crowdreview_web, CrowdReview.Web.Endpoint,
  on_init: {CrowdReview.Web.Endpoint, :load_from_system_env, []},
...
# start per endpoint:
#
#     config :crowdreview_web, CrowdReview.Web.Endpoint, server: true
#
