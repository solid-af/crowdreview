...
var _solid_af$crowdreview$Main$viewBody = function (model) {
...
var _solid_af$crowdreview$Main$viewHeader = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Crowd Review'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _solid_af$crowdreview$Main$viewMenu = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{ctor: '[]'});
};
var _solid_af$crowdreview$Main$model = {count: 0, mdl: _debois$elm_mdl$Material$model};
var _solid_af$crowdreview$Main$Model = F2(
	function (a, b) {
		return {count: a, mdl: b};
	});
var _solid_af$crowdreview$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _solid_af$crowdreview$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return A3(_debois$elm_mdl$Material$update, _solid_af$crowdreview$Main$Mdl, _p0._0, model);
	});
var _solid_af$crowdreview$Main$view = function (model) {
	return A4(
		_debois$elm_mdl$Material_Layout$render,
		_solid_af$crowdreview$Main$Mdl,
		model.mdl,
		{
			ctor: '::',
		...
		},
		{
			header: {
				ctor: '::',
				_0: _solid_af$crowdreview$Main$viewHeader(model),
				_1: {ctor: '[]'}
			},
			drawer: {
				ctor: '::',
				_0: _solid_af$crowdreview$Main$viewMenu(model),
				_1: {ctor: '[]'}
			},
			tabs: {
				ctor: '_Tuple2',
			...
			main: {
				ctor: '::',
				_0: _solid_af$crowdreview$Main$viewBody(model),
				_1: {ctor: '[]'}
			}
		});
};
var _solid_af$crowdreview$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _solid_af$crowdreview$Main$model, _1: _elm_lang$core$Platform_Cmd$none},
		view: _solid_af$crowdreview$Main$view,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
		update: _solid_af$crowdreview$Main$update
	})();
